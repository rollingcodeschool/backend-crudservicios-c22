...
router.route('/:id').get(validacionIDServicio,buscarServicioPorID).delete(validacionIDServicio,borrarServicioPorID).put([validacionIDServicio, validacionServicio],editarServicioPorID).patch([validacionIDServicio ], editarServicioPorID)
